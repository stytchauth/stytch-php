...
final class AuthenticateResponse
{
    ...
    *   See [Session object](https://stytch.com/docs/api/session-object) for complete response fields.
    ...
    public ?SIWEParamsResponse $siweParams = null;
    /**
    ...
    * `user_device` response field will contain information about the user's device attributes.
    ...
    public function __construct(
        ...
        ?SIWEParamsResponse $siweParams = null,
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            isset($data['siwe_params']) && $data['siwe_params'] !== null ? SIWEParamsResponse::fromArray($data['siwe_params']) : null,
