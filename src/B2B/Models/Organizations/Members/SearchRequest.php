...
final class SearchRequest
{
    ...
    * you include no query object, it will return all Members with no filtering applied.
     */
    public ?\Stytch\B2B\Models\Organizations\SearchQuery $query = null;

    public function __construct(
        array $organizationIds,
        ?string $cursor = null,
        ?int $limit = null,
        ?\Stytch\B2B\Models\Organizations\SearchQuery $query = null
    ) {
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            $data['cursor'] ?? null,
            $data['limit'] ?? null,
            isset($data['query']) && $data['query'] !== null ? \Stytch\B2B\Models\Organizations\SearchQuery::fromArray($data['query']) : null
        );
    }
