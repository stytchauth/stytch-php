...
final class ExchangeResponse
{
    ...
    * 2XX values equate to success, 3XX values are redirects, 4XX are client errors, and 5XX are server errors.
    ...
    public ?PrimaryRequired $primaryRequired = null;
    /**
    ...
    * `member_device` response field will contain information about the member's device attributes.
    ...
    public function __construct(
        ...
        ?PrimaryRequired $primaryRequired = null,
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            isset($data['primary_required']) && $data['primary_required'] !== null ? PrimaryRequired::fromArray($data['primary_required']) : null,
