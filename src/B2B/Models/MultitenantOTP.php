...
class EmailOTPDiscoverySendResponse
{
...
class EmailOTPAuthenticateResponse
{
...
class EmailOTPLoginOrSignupResponse
{
    public string $member_id;
...
class EmailOTPDiscoveryAuthenticateResponse
{
    public string $intermediate_session_token;
