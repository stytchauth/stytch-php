...
final class StrengthCheckResponse
{
    ...
    * [zxcvbn](https://stytch.com/docs/b2b/guides/passwords/strength-policy).
    ...
    public function __construct(
        ...
        int $statusCode,
        ?LudsFeedback $ludsFeedback = null,
        ?ZxcvbnFeedback $zxcvbnFeedback = null
    ) {
        ...
        $this->ludsFeedback = $ludsFeedback;
        $this->zxcvbnFeedback = $zxcvbnFeedback;
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'luds_feedback' => $this->ludsFeedback,
            'zxcvbn_feedback' => $this->zxcvbnFeedback,
        ];
    }
}
